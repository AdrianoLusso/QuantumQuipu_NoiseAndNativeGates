...
class Unified_Noise_Model:
    ...
    def print_calibration_data(self):
        print('------------------------------------------------')
        print('SINGLE QUBIT BASIS GATES:')
        print(self.single_qubit_basis_gates)
        print('------------------------------------------------')
        print('TWO QUBITS BASIS GATES:')
        print(self.two_qubits_basis_gates)
        print('------------------------------------------------')
        print('QUBITS:')
        print(self.qubits)
        print('------------------------------------------------')
    ...
    def add_depolarizing_channel2(self):
        ...
        for qubits_pair in keys:
            ...
            self.noise_model.add_quantum_error(error,self.two_qubits_basis_gates,[int(qubits[0]),int(qubits[1])])
